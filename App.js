  ...
  return (
    <div className="header">
      <div className="logo-container">
        <img
          className="logo"
          src="https://img.freepik.com/free-vector/delivery-service-illustrated_23-2148505081.jpg?size=626&ext=jpg"
        />
      </div>
...
const resObj = [
  {
    ...
    "analytics": {
      "context": "seo-data-f3781303-1f69-4562-8443-6f4164750ed6"
    },
    "cta": {
  ...
  },
  {
    "info": {
      ...
      "availability": {
        "nextCloseTime": "2024-02-02 01:30:00",
        "opened": true
      },
      "badges": {
  ...
  },
  {
    ...
    "cta": {
      "link": "https://www.swiggy.com/restaurants/thenga-manga-by-chef-pillai-brigade-road-central-bangalore-bangalore-748103",
      "text": "RESTAURANT_MENU",
      "type": "WEBLINK"
    },
    "widgetId": "collectionV5RestaurantListWidget_SimRestoRelevance_food_seo"
        ...
        return (
                <div className="body">
                  ...
                  <div className="res-container">
                    {resObj.map((restaurant) =><RestrauntCard key={restaurant.info.id} resData = {restaurant}/>) }                   
                  </div>
                </div>
